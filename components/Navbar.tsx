...
function WalletBalance() {
  ...
  return (
    <span className="text-xs bg-neutral-900 text-white rounded px-2 py-1">
...
export default function Navbar() {
  ...
  useEffect(() => {
    if (address) switchChain({ chainId: 11155111 }); // auto-switch to  Sepolia
  }, [address, switchChain]);

  return (
    <div className="pt-8 pb-4 flex items-center justify-between max-w-7xl mx-auto">
      <div className="text-2xl font-semibold tracking-wide">Rekt Rescue</div>
      <div className="flex gap-4 items-center">
        ...
        <section className="flex justify-center items-center">
          <button
            className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413] relative"
            onClick={() => window.open("https://x.com/THE_SANDF", "_blank")}
            type="button"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
